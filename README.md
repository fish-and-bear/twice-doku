...
**_A note about the .exe file:_** *The .exe file seems to be unstable due to the lack of hooks with the Pygame GUI dependency. I am looking into this. For the meantime, if you can, __please follow the installation steps above and use the .py files!__*
