...
""" [Level of Difficulty] = Input the level of difficulty of the sudoku puzzle. Difficulty levels
        include ‘Easy’ ‘Mild’ ‘Difficult’ and ‘Insane’. Outputs a sudoku of desired
        difficulty."""
...
def solver(sudoku, f = 0):
    ...
    while solvedCells != []:
        for n in solvedCells:
            ...
            for i in cells:  # Now we iterate through the remaing unset cells and remove the input if it's in the same row, col, or box
